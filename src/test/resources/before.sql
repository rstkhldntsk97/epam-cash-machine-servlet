...
insert into product (code, price, quantity) values(1, 100, 100),(2, 200, 200),(3, 300, 300),(4, 400, 400),(5, 500, 500),(6, 600, 600),(7, 700, 700),(8, 800, 800),(9, 900, 900),(10, 1000, 1000),
                                                  (11, 1100, 1100),(12, 1200, 1200),(13, 1300, 600),(14, 1400, 1400),(15, 1500, 1500),(16, 1600, 1600),(17, 1700, 1700),(18, 1800, 1800),(19, 1900, 1900),(20, 2000, 2000);

insert into product_translate(product_code, lang_id, name) values
(1, 1, 'bed'), (1, 2, 'ліжко'),
(2,1, 'window'), (2, 2, 'вікно'),
(3,1, 'laptop'), (3,2,'ноутбук'),
(4,1, 'phone'), (4,2,'телефон'),
(5,1, 'tv'), (5,2,'телевізор'),
(6,1, 'pc'), (6,2,'компютер'),
(7,1, 'headphones'), (7,2,'наушники'),
(8,1, 'table'), (8, 2, 'стіл'),
(9,1, 'house'), (9, 2, 'будинок'),
(10,1, 'flat'), (10, 2, 'квартира'),
(11,1, 'mouse'), (11, 2, 'мишка'),
(12,1, 'keyboard'), (12, 2, 'клавіатура'),
(13,1, 'display'), (13, 2, 'монітор'),
(14,1, 'speaker'), (14, 2, 'динамік'),
(15,1, 'door'), (15, 2, 'двері'),
(16,1, 'cat'), (16, 2, 'кіт'),
(17,1, 'dog'), (17, 2, 'собака'),
(18,1, 'brain'), (18, 2, 'мозок'),
(19,1, 'hand'), (19, 2, 'рука'),
(20,1, 'leg'), (20, 2, 'нога');
...
(3, 6, 10, 500),
(4, 20, 3, 1200), (4, 1, 3, 6750), (4, 19, 2, 1600),(4, 10, 5, 12000), (4, 6, 8, 400),
...
(8, 11, 30, 27000), (8, 2, 30, 33000), (8, 3, 20, 10000),(8, 14, 50, 20000),
